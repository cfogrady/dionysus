package org.dionysus.streamer.util;
...
/**
 * Originally written by Davin Kevin from https://gist.github.com/davinkevin/b97e39d7ce89198774b4
 * Modified by Jamaslab to use RandomAccessFile here: https://stackoverflow.com/questions/28427339/how-to-implement-http-byte-range-requests-in-spring-mvc
 * Further modified by cfogrady in dionysus project
 */
public class MultipartFileSender {
    ...
    /**
     * Attempts to derrive content-type using the filename extension
     * @param filename
     * @return
     */
    private String getContentTypeFromFilename(String filename) {
        ...
        logger.error("File {} has an extension {} not currently mapped to a mime-type", filename, extension);
        return null;
    }
